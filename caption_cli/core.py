...
COMMAND_TABLE_FIELDS = {
    "list_matters": ("id", "name", "full_name"),
    "list_md": ("id", "project", "title", "plain_text_preview", "tags"),
}
...
def render_output(
    ...
    *,
    ...
    if output_format == "table" and command_name == "search":
        return _render_search_summary_table(value, search_index)
    return _render_table(value, command_name=command_name)
