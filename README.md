...
uv run caption tail --link https://app.caption.fyi/shared/2qzfgA7_74Ph7Gsy --max-events 10
uv run caption tail transcript-uuid --link 2qzfgA7_74Ph7Gsy --duration 60
```
