...
def test_build_auth_headers_supports_bearer_visa_and_both() -> None:
    ...
    assert core._build_auth_headers(None, "SHARE_TOKEN") == {"x-caption-visa": "SHARE_TOKEN"}
    assert core._build_auth_headers("api-token", "SHARE_TOKEN") == {
        "Authorization": "Bearer api-token",
        "x-caption-visa": "SHARE_TOKEN",
    }
...
@pytest.mark.parametrize(
    ...
    [
        "SHARE_TOKEN",
        "https://app.caption.fyi/shared/SHARE_TOKEN",
        "https://app.caption.fyi/shared/SHARE_TOKEN/",
        "https://app.caption.fyi/shared/SHARE_TOKEN?utm=x#frag",
        "  SHARE_TOKEN  ",
    ],
)
def test_parse_share_token_accepts_urls_and_bare_tokens(value: str) -> None:
    ...
    assert parse_share_token(value) == "SHARE_TOKEN"
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "https://app.caption.fyi/projects/SHARE_TOKEN",
        "SHARE_TOKEN-extra-characters",
    ],
)
...
def test_resolve_shared_transcript_uses_visa_guest_auth_and_most_recent_transcript(
    ...
    def fake_authorized_get(
        ...
        **kwargs: Any,
        ...
        assert path == "/access/visa/SHARE_TOKEN"
    ...
    def fake_fetch_paginated(
        ...
        **kwargs: Any,
        ...
        assert kwargs.get("visa_token") == "SHARE_TOKEN"
        return [
    ...
    transcript_id, share = resolve_shared_transcript("https://api.example.com/api", "SHARE_TOKEN")
...
def test_resolve_shared_transcript_rejects_non_project_or_empty_shares(
    ...
    with pytest.raises(core.CliError) as excinfo:
        resolve_shared_transcript("https://api.example.com/api", "SHARE_TOKEN")
...
def test_command_tail_with_link_never_sends_clerk_token_and_adds_visa_to_socket_auth(
    ...
    command_tail(
        ...
        max_events=1,
        idle_timeout=None,
        link="https://app.caption.fyi/shared/SHARE_TOKEN",
    )
    ...
    assert client.auth_payloads == [
        {"token": "events-token", "visaToken": "SHARE_TOKEN"},
        {"token": "events-token", "visaToken": "SHARE_TOKEN"},
    ]
...
def test_parse_args_for_tail_accepts_link_flag() -> None:
    args = cli.parse_args(
        ["--env-file", "", "tail", "--link", "https://app.caption.fyi/shared/SHARE_TOKEN", "--max-events", "1"]
    )
    assert args.command == "tail"
    assert args.transcript_id is None
    assert args.link == "https://app.caption.fyi/shared/SHARE_TOKEN"
